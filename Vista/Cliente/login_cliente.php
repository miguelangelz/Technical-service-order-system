<?php
require'../../Modelo/login_cliente.php';
?>
<!DOCTYPE html>
<html lang="en">
<head>
        ...
        <div class="row">
			...
			?>
                    <div class="panel-heading">
                        <h3 class="panel-title">Por Favor ingrese su numero de c&eacute;dula</h3>
                    </div>
                        ...
                        <form role="form"  method="post" name="login">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Ingrese la c&eacute;dula" name="cedula" id="usuario" type="text" autofocus />
                                </div>
