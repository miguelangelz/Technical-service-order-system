...
class reporteOrdenGarantia extends FPDF{
    
    function Header(){
        $this->SetFont('Arial','B',15);
        $this->Cell(100,10,$this->Image('../assets/img/LOGO_APC.png', $this->GetX()+01, $this->GetY()+5, 30) ,0,"L");
        $this->Cell(10,10,utf8_decode('ORDEN DE GARANTIA'),0,1,'C');
    ...
    function Footer() {
        ...
        $this->SetFont('Arial','',8);
        $this->MultiCell(0,4,utf8_decode('1.- Es responsabilidad del cliente mantener un respaldo del software preinstalado'
        ...
        $this->SetFont('Arial','',8);
        $this->MultiCell(0,4,utf8_decode('2.- Abraham Pañi Cajamarca Cia Ltda. no se responsabiliza por la mercaderia que no'
        ...
        $this->SetFont('Arial','',8);
        $this->MultiCell(0,4,utf8_decode('3.- El cliente tiene la obligacion de revisar que su equipo este en las'
                . 'condiciones detalladas en este documento, una vez retirado de nuestra compañia no se aceptan reclamos.'),0,'L',0);
