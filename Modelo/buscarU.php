...
$cli = $clients->fetchAll(PDO::FETCH_OBJ);
 ...
 foreach($cli as $client){                
                        ...
                        '<tr>'.
                            ...
                            '<td>
                                <a class="btn btn-primary" href="editarClientesU.php?client='. $client->cli_id .'"><i class="fa fa-edit fa-fw"></i> Actualizar</a> 
                                <a class="btn btn-danger" href="../../Controlador/Persona/deleteClienteU.php?client='. $client->cli_id .'"><i class="fa fa-trash fa-fw"></i> Borrar</a>   
                            </td>',
                        '</tr> ';
